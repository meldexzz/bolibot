...
if (!effect) throw '⚠️ ¿𝐂𝐨𝐦𝐨 𝐮𝐬𝐚𝐫 𝐞𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 🥖?\𝘯• .𝘭𝘰𝘨𝘰 (𝘦𝘧𝘦𝘤𝘵𝘰)(𝘵𝘦𝘹𝘵𝘰) \𝘯 𝐄𝐣𝐞𝐦𝐩𝐥𝐨:\𝘯\𝘯 • .𝘭𝘰𝘨𝘰 3𝘥-𝘥𝘦𝘦𝘱-𝘴𝘦𝘢-𝘮𝘦𝘵𝘢𝘭 𝘉𝘰𝘭𝘪𝘭𝘭𝘰_\𝘯\𝘯⚠️ 𝐂𝐮𝐚𝐧𝐝𝐨 𝐥𝐞𝐬 𝐝𝐢𝐠𝐚 𝐪𝐮𝐞 𝐡𝐚𝐜𝐞 𝐟𝐚𝐥𝐭𝐚 𝐮𝐧 𝐭𝐞𝐱𝐭𝐨 𝐞𝐥 𝐮𝐬𝐨 𝐬𝐞𝐫𝐢𝐚:\𝘯• 𝘭𝘰𝘨𝘰 (𝘦𝘧𝘦𝘤𝘵𝘰) (𝘵𝘦𝘹𝘵𝘰1|𝘵𝘦𝘹𝘵𝘰2)\𝘯𝐄𝐣𝐞𝐦𝐩𝐥𝐨:\𝘯• 𝘭𝘰𝘨𝘰 𝘞𝘰𝘭𝘧-𝘓𝘰𝘨𝘰-𝘎𝘢𝘭𝘢𝘹𝘺 𝘉𝘰𝘭𝘪𝘭𝘭𝘰|𝘉𝘰𝘵\n\n<𝑳𝑰𝑺𝑻𝑨 𝑫𝑬 𝑬𝑭𝑬𝑪𝑻𝑶𝑺/>\n\n° ඬ⃟📝 #logo ' + effects.map((v) => v.title).join('\n° ඬ⃟📝 #logo ');
