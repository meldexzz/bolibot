...
if (!text) return m.reply(`¿𝙉𝙊 𝙎𝘼𝘽𝙀𝙎 𝙌𝙐𝙀 𝘽𝙐𝙎𝘾𝘼𝙍?\n𝙄𝙉𝙂𝙍𝙀𝙎𝙀 𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀 𝙇𝘼 𝘾𝘼𝙉𝘾𝙄Ó𝙉 🥖\n\n𝙀𝙅𝙀𝙈𝙋𝙇𝙊:\n.𝙥𝙡𝙖𝙮 𝙨𝙖𝙘𝙖 𝙡𝙤𝙨 𝙗𝙤𝙡𝙞𝙡𝙡𝙤𝙨`) 
...
*𝙀𝙨𝙥𝙚𝙧𝙚 𝙪𝙣 𝙢𝙤𝙢𝙚𝙣𝙩𝙤, 𝙚𝙣 𝙡𝙤 𝙦𝙪𝙚 𝙚𝙣𝙫𝙞ó 𝙨𝙪: ${tipoDescarga}*`,  
contextInfo:{  
forwardedNewsletterMessageInfo: { 
newsletterJid: '120363190400869019@newsletter', 
serverMessageId: '', 
newsletterName: 'BOLILLO BOT' },
